...
<template>
    <div>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>保养管理</el-breadcrumb-item>
        </el-breadcrumb>
        <!-- 搜索筛选 -->
        <el-form :inline="true" :model="form" class="user-search">
            ...
            <el-form-item>
                ...
                <el-button icon="el-icon-circle-plus" size="small" type="primary"
                           @click="$router.push(`/onSiteInspection/patrolInspectionPlan`)">新建巡检计划
                </el-button>
                <el-button icon="el-icon-download" size="small" type="primary">批量导出</el-button>
            </el-form-item>
        </el-form>
        <!--列表-->
        <el-table
            ...
            <el-table-column align="center" label="计划编号" prop="deptName">
            </el-table-column>
            <el-table-column align="center" label="计划名称" prop="userName">
            </el-table-column>
            <el-table-column align="center" label="执行方式" prop="userRealName">
            </el-table-column>
            <el-table-column align="center" label="设备类型" prop="userMobile">
            </el-table-column>
            <el-table-column align="center" label="巡检周期" prop="userSex" width="80">
            </el-table-column>
            <el-table-column align="center" label="巡检类型" prop="userEmail">
            </el-table-column>
            <el-table-column align="center" label="计划状态" prop="editTime"></el-table-column>
            <el-table-column align="center" label="巡检设备数量" prop="isLock"></el-table-column>
            <el-table-column align="center" label="巡检科室数量" prop="isLock"></el-table-column>
            <el-table-column align="center" label="巡检任务期限" prop="isLock"></el-table-column>
