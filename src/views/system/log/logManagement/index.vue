...
<template>
    <div>
        ...
        <el-table
            ...
            <el-table-column align="center" label="日志编号" prop="deptName">
            </el-table-column>
            <el-table-column align="center" label="时间" prop="userName">
            </el-table-column>
            <el-table-column align="center" label="错误内容" prop="userRealName">
            </el-table-column>
            <el-table-column align="center" label="操作人" prop="userMobile">
            </el-table-column>
