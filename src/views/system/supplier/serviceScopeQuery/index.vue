<template>
    <div>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>服务范围查询</el-breadcrumb-item>
        </el-breadcrumb>
        <!-- 搜索筛选 -->
        ...
        <el-table
            ...
            <el-table-column align="center" label="使用时间" prop="deptName">
            </el-table-column>
            <el-table-column align="center" label="病人信息" prop="userName">
            </el-table-column>
            <el-table-column align="center" label="结束时间" prop="userRealName">
            </el-table-column>
            <el-table-column align="center" label="终末处理" prop="userMobile">
            </el-table-column>
            <el-table-column align="center" label="项目名称" prop="userSex" width="80">
            </el-table-column>
            <el-table-column align="center" label="操作人" prop="isLock"></el-table-column>
