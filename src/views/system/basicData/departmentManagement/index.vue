    ...
    <div>
        ...
        <el-form :inline="true" :model="form" class="user-search">
            ...
            <el-form-item>
                ...
                <el-button icon="el-icon-circle-plus" size="small" type="primary" @click="editFormVisible = true">新建科室</el-button>
            </el-form-item>
        </el-form>
        <!--列表-->
        <el-table
            ...
            <el-table-column align="center" label="科室代码" prop="userName">
            </el-table-column>
            <el-table-column align="center" label="科室座机" prop="userRealName">
            </el-table-column>
            <el-table-column align="center" label="创建时间" prop="userMobile">
            </el-table-column>
        ...
        <el-dialog :visible.sync="editFormVisible" title="新建科室" width="30%">
            <el-form ref="ruleForm" :model="ruleForm" :rules="rules" class="demo-ruleForm" label-width="80px">
                ...
                <el-form-item label="科室座机" prop="name">
                    <el-input v-model="ruleForm.name"></el-input>
                </el-form-item>
            </el-form>
