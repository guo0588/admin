...
<template>
    <div>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>年度计划</el-breadcrumb-item>
        </el-breadcrumb>
        <!-- 搜索筛选 -->
        <el-form :inline="true" :model="form" class="user-search">
            ...
            <el-form-item>
                <el-button icon="el-icon-search" size="small" type="primary" @click="search">搜索</el-button>
                    <el-button icon="el-icon-circle-plus" size="small" type="primary" @click="$router.push(`/annualPlan/newPlan/1231231`)">新建计划</el-button>
        ...
        <el-table
            ...
            <el-table-column align="center" label="申请进度" prop="deptName">
            </el-table-column>
            <el-table-column align="center" label="年度" prop="userName">
            </el-table-column>
            <el-table-column align="center" label="编制科室" prop="userRealName">
            </el-table-column>
            <el-table-column align="center" label="使用科室" prop="userMobile">
            </el-table-column>
            <el-table-column align="center" label="项目名称" prop="userSex" width="80">
            </el-table-column>
            <el-table-column align="center" label="数量" prop="userEmail">
            </el-table-column>
            <el-table-column align="center" label="金额" prop="editTime"></el-table-column>
