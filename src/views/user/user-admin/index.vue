    ...
    <div>
        ...
        <el-form :inline="true" :model="formInline" class="user-search">
            ...
            <el-form-item>
                ...
                <el-button icon="el-icon-plus" size="small" type="primary" @click="handleEdit()">添加</el-button>
        ...
        <el-table id="printMe" v-loading="loading" :data="userData" border element-loading-text="拼命加载中" highlight-current-row size="small" style="width: 100%;" @selection-change="selectChange">
            ...
            <el-table-column align="center" label="公司" prop="deptName" min-width="60" show-overflow-tooltip >
            </el-table-column>
            <el-table-column align="center" label="用户名" prop="userName" min-width="50" show-overflow-tooltip >
            </el-table-column>
            <el-table-column align="center" label="姓名" prop="userRealName" min-width="50" show-overflow-tooltip >
            </el-table-column>
            <el-table-column align="center" label="手机号" prop="userMobile" min-width="60" show-overflow-tooltip >
            </el-table-column>
            <el-table-column align="center" label="性别" min-width="50" width="80" prop="userSex" show-overflow-tooltip>
            </el-table-column>
            ...
            <el-table-column align="center" label="状态" min-width="40" width="80" prop="isLock" show-overflow-tooltip>
                <template slot-scope="scope">
            ...
            <el-table-column label="操作" min-width="170" width="325" align="center" show-overflow-tooltip>
                <template slot-scope="scope">
        ...
        <el-dialog :title="title" :visible.sync="editFormVisible" width="30%" @click='closeDialog("edit")'>
            <el-form ref="editForm" :model="editForm" :rules="rules" label-width="80px">
                <el-form-item label="用户名" prop="userName">
                    <el-input v-model="editForm.userName"  placeholder="请输入用户名" size="small"></el-input>
                </el-form-item>
                <el-form-item label="姓名" prop="userRealName">
                    <el-input v-model="editForm.userRealName" auto-complete="off" placeholder="请输入姓名" size="small"></el-input>
                </el-form-item>
                <el-form-item label="角色" prop="roleId">
                    <el-select v-model="editForm.roleId" class="userRole" placeholder="请选择" size="small">
                        <el-option label="公司管理员" value="1"></el-option>
                        <el-option label="普通用户" value="2"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="手机号" prop="userMobile">
                    <el-input v-model="editForm.userMobile" placeholder="请输入手机号" size="small"></el-input>
                </el-form-item>
                <el-form-item label="邮件" prop="userEmail">
                    <el-input v-model="editForm.userEmail" placeholder="请输入邮箱地址" size="small"></el-input>
                </el-form-item>
        ...
        <!-- 所属单位 -->
        <el-dialog :visible.sync="unitAccessshow" title="所属单位" width="30%" @click='closeDialog("unit")'>
            <el-tree ref="tree" :data="UserDept" :default-checked-keys="checkmenu" :props="defaultProps" check-strictly default-expand-all="" node-key="id" show-checkbox @check-change="handleClick">
            </el-tree>
            <div slot="footer" class="dialog-footer">
                <el-button size="small" @click='closeDialog("unit")'>取消</el-button>
                <el-button :loading="loading" class="title" size="small" type="primary" @click="unitPermSave">保存</el-button>
            </div>
        </el-dialog>
    </div>
</template>
